...
//   export function compose<T>(funcs: IConnectFunctions): (component: any) => __React.StatelessComponent<T>;
//   export function connect<T>(funcs: IConnectFunctions): (component: any) => __React.StatelessComponent<T>;
